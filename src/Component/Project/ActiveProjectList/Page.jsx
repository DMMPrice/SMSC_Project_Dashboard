...
export default function ProjectListTable() {
    ...
    const fetchProjects = async () => {
        ...
        try {
            ...
            const incompleteProjects = projects.filter((proj) => proj.is_completed === false);

            const formatted = await Promise.all(
                incompleteProjects.map(async (proj) => {
    ...
    return (
        <div className="p-6">
            {/* + Add Project Button */}
            {(role === "Super Admin" || role === "Admin" || role === "Manager" || role === "Employee") && (
            ...
            {loading ? (
                ...
                <>
                    <AdvancedTable
                        ...
                        data={projects}
                        userRole={userRole}
                        editRoles={["Admin", "Super Admin", "Employee"]}
                        onEdit={(row) => {
